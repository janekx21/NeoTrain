...
view userCount t =
    column [ topLeftBar [ backButton t Back, logoutButton t Logout ], spacing 16, width (px 512) ]
        ...
        , subTitle "Über Mich"
        , paragraph [] [ text "Ich bin Janek, studiere Informatik an der OvGU und programmiere super gerne in Elm. Ich habe diese Web-App aus Libe zu Neo und Elm gebaut." ]
        , column [ centerX ]
            [ row [ centerX ]
                [ el [ padding 16 ] <| link (buttonAttributes t) { url = "https://github.com/janekx21/Neotrain", label = text "Github Repository" }
                , el [ padding 16 ] <| link (buttonAttributes t) { url = "https://github.com/janekx21", label = text "Mein Github" }
                ]
            , el [ padding 16, centerX ] <| link (buttonAttributes t) { url = "https://github.com/janekx21/NeoTrain/issues/new", label = text "Problem melden" }
            ]
